...
<div class="right_col" role="main">
	<div class="page-title">
		<div class="title pull-right">
			<p><a href="<?= base_url('admin'); ?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a> | Data Penerima Bantuan</p>
		</div>
	</div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<div class="row mt-3">
						<div class="col-md-6">
							<a href="" class="btn btn-round btn-primary" data-toggle="modal" data-target="#tambahAlternatif">
								<i class="fa fa-plus-circle"></i> Penerima Bantuan</a>
						</div>
					</div>
							...
							<?php foreach ($tbl_alternatif as $alternatif) : ?>
								<tr>
									...
									<td class="vertical-center" style="text-align: center;">
										<a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target=".ubahAlternatif<?= $alternatif['id_alternatif']; ?>">
											<i class="fas fa-edit"></i> Edit
										</a>
										<a href="<?= base_url('alternatif/hapus/') . $alternatif['id_alternatif']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Data yang telah dihapus tidak dapat dikembalikan. Yakin ingin menghapus data?');">
